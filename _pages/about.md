...
**工程与系统能力：**
除了算法研究，我对 **Linux 系统架构与服务部署**有着深入的钻研。为了优化科研协作效率与数据私密性，我利用 **Docker** 容器化技术，在实验室私有服务器上独立部署并维护了 **WandB (Weights & Biases)** 本地化实例与 **Overleaf Community** 协作平台。我具备扎实的 Linux 运维能力，熟悉 **GPU 服务器环境配置 (CUDA/Driver)** 及自动化工作流搭建，致力于构建高效、稳定的科研基础设施。
...
* **[2025.09]** 荣获校级一等奖学金。
* **[2024.12]** 荣获第10届中国研究生智慧城市技术与创意设计大赛 **国家级一等奖**。
* **[2024.11]** 论文获得 **IEEE ISPCE-Asia 2024 Best Paper Award**。
...
**大模型驱动的航空领域对话培训助手**
*主要参与者*
* 负责项目核心技术方案撰写，包括基座模型选型、数据处理流程与微调策略。
* 深入调研并设计了基于大模型的对话系统实现路径。

**网算智一体化架构下的智能网联车队协同驾驶系统**
*核心骨干 (排名第二)*
* 该项目荣获第10届中国研究生智慧城市技术与创意设计大赛**国家级一等奖**。
...
* **2025**: 武汉理工大学校级一等奖学金
* **2024**: 第10届中国研究生智慧城市技术与创意设计大赛 国家级一等奖
* **2024**: IEEE ISPCE-Asia 2024 最佳论文奖 (Best Paper Award)
