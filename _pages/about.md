...
**工程与系统能力：**
在算法研究之余，我也熟悉 **Linux 环境下的开发与服务部署**。为了提升实验室内部的协作效率与数据管理便捷性，我利用 Docker 独立部署了 **WandB (本地化实验记录)** 与 **Overleaf (本地化论文协作)** 服务。此外，我熟悉 GPU 服务器的基础配置与环境管理，能够独立解决大部分科研环境中的软硬件适配问题。
